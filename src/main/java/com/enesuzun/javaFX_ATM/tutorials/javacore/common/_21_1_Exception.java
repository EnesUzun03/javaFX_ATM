package com.enesuzun.javaFX_ATM.tutorials.javacore.common;
...
public class _21_1_Exception {
    ...
    // PSVM
    public static void main(String[] args) throws ArithmeticException, IndexOutOfBoundsException, enesuzunException {
        ...
        throw new enesuzunException(" burada bilerek istisna oluşturdum.");
